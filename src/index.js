...
const Index = () => {
  ...
  const ideatText = 'The idea started as a problem of following multiple influencers. We spend lots of time on social media by following many influencers. The influencers are becoming increasingly popular for consumers, and new social mediums are popping up constantly. This results in a scattered digital presence across several platforms. The idea is to bring the millenials and gen z back to the TV, making it relevant again. With a platform curating content from multiple open sources the user never has to leave the app and will be directly linked to the relevant pages.'
  const companytText = 'Pumba consists of 25 driven and motivated students who during one semester will act like a real professional company and develop a smart tv application. We are studying at Linköpings University at three different programs, everyone with a burning interest of digital solutions. The company is newly started and with our qualification, drive and open work environment, we are excited to after three months deliver the best possible product.'
